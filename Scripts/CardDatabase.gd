...
const CARDS = {
	...
	"Archer": [3, 1, "Character", "When played to field, deal 1 direct damage", "res://Scripts/Abilities/ArrowShot.gd"],
	"BlueSlime": [4, 1, "Character", null, null],
	"RedSlime": [4, 1, "Character", null, null],
	"GreenSlime": [3, 1, "Character", "This card can attack twice", "res://Scripts/Abilities/DoubleAttack.gd"],
