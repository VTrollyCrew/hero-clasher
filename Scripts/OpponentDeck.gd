...
func draw_card():
	...
	new_card.attack = card_database_reference.CARDS[card_drawn_name][0] # Note that this is implemented to get the attack value to calculate what is the best card for opponent. But can be recycled
